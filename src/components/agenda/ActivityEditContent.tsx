...
// Gedeeld tussen de volledige pagina (/agenda/[id]/bewerken) en de
// intercepted overlay (@modal/(.)agenda/[id]/bewerken).
export async function ActivityEditContent({ id }: { id: string }) {
  await requireBoard();
