...
export function AppShell({
  ...
  return (
    <div className="min-h-dvh bg-background">
      <Sidebar profile={profile} unreadCount={unreadCount} avatarUrl={avatarUrl} companyId={companyId} />
      ...
      <BottomNav profile={profile} avatarUrl={avatarUrl} companyId={companyId} />
    </div>
  );
}
